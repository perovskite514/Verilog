...
proc create_root_design { parentCell } {
  ...
  # Create instance: div32p2_0, and set properties
  set block_name div32p2
  set block_cell_name div32p2_0
  if { [catch {set div32p2_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net c_shift_ram_0_Q [get_bd_pins c_shift_ram_0/D] [get_bd_pins c_shift_ram_0/Q] [get_bd_pins div32p2_0/x]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets c_shift_ram_0_Q]
  connect_bd_net -net c_shift_ram_1_Q [get_bd_pins c_shift_ram_1/D] [get_bd_pins c_shift_ram_1/Q] [get_bd_pins div32p2_0/d]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins c_shift_ram_1/CLK] [get_bd_pins c_shift_ram_2/CLK] [get_bd_pins c_shift_ram_3/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins div32p2_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins div32p2_0/rstn]
  connect_bd_net -net div32p2_0_q [get_bd_pins c_shift_ram_2/D] [get_bd_pins div32p2_0/q]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets div32p2_0_q]
  connect_bd_net -net div32p2_0_r [get_bd_pins c_shift_ram_3/D] [get_bd_pins div32p2_0/r]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets div32p2_0_r]
