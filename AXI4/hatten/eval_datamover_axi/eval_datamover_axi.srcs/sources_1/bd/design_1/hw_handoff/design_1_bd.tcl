...
connect_bd_intf_net -intf_net [get_bd_intf_nets datamover_axi_wrap_0_axi] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins axi_protocol_checker_0/PC_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_protocol_checker_0/aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins c_shift_ram_1/CLK] [get_bd_pins datamover_axi_wrap_0/clk] [get_bd_pins sim_clk_gen_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_protocol_checker_0/aresetn] [get_bd_pins datamover_axi_wrap_0/rstn] [get_bd_pins sim_clk_gen_0/sync_rst]
