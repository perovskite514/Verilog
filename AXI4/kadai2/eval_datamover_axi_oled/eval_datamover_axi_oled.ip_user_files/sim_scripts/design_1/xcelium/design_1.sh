...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../eval_datamover_axi_oled.srcs/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"../../../../eval_datamover_axi_oled.srcs/sources_1/bd/design_1/ipshared/d0f7"
}
