...
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { ledstatn } ]; #IO_L18N_T2_35 Sch=led0_b
...
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { ledrdy }]; #IO_L23P_T3_35 Sch=led3_b
...
#set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { btn23[0] }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
#set_property -dict { PACKAGE_PIN B8 IOSTANDARD LVCMOS33 } [get_ports { btn23[1] }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
