...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../test_uart_loopback_9600.srcs/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"../../../../test_uart_loopback_9600.srcs/sources_1/bd/design_1/ipshared/d0f7"
}
