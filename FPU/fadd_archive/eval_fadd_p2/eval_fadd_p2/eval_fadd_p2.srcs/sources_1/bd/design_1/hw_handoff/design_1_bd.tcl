...
proc create_root_design { parentCell } {
  ...
  # Create instance: fadd_p2_wrap_0, and set properties
  set block_name fadd_p2_wrap
  set block_cell_name fadd_p2_wrap_0
  if { [catch {set fadd_p2_wrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fadd_p2_wrap_0 eq "" } {
  ...
  connect_bd_net -net c_shift_ram_0_Q [get_bd_pins c_shift_ram_0/D] [get_bd_pins c_shift_ram_0/Q] [get_bd_pins fadd_p2_wrap_0/x1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets c_shift_ram_0_Q]
  connect_bd_net -net c_shift_ram_1_Q [get_bd_pins c_shift_ram_1/D] [get_bd_pins c_shift_ram_1/Q] [get_bd_pins fadd_p2_wrap_0/x2]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins c_shift_ram_1/CLK] [get_bd_pins c_shift_ram_2/CLK] [get_bd_pins c_shift_ram_3/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins fadd_p2_wrap_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins fadd_p2_wrap_0/rstn]
  connect_bd_net -net fadd_p2_wrap_0_ovf [get_bd_pins c_shift_ram_3/D] [get_bd_pins fadd_p2_wrap_0/ovf]
  connect_bd_net -net fadd_p2_wrap_0_y [get_bd_pins c_shift_ram_2/D] [get_bd_pins fadd_p2_wrap_0/y]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets fadd_p2_wrap_0_y]
